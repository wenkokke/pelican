...
public final class TestPel2Shared0111 extends AbsPipelineTest {
		...
		public final void testPel2Shared0111() throws Exception {
			...
			val t04_gross = word("$NPC_1$","Gross",4);
			val t05_domestic = word("$NPC_1$","domestic",5);
			val t06_product = word("NP_D","product",6);
			...
			val h01_gross = word("$NPC_1$","Gross",1);
			val h02_domestic = word("$NPC_1$","domestic",2);
			val h03_product = word("NP_D","product",3);

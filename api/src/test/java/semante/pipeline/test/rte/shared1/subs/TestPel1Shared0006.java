...
public final class TestPel1Shared0006 extends AbsPipelineTest {
		...
		public final void testPel1Shared0006() throws Exception {
			...
			val t10_core = word("$NC_1$","core",10);
			val t11_technology = word("N","technology",11);
			...
			val t20_maglev = word("$NC_1$","Maglev",20);
			val t21_line = word("N","line",21);
			...
			val h13_maglev = word("$NC_1$","Maglev",13);
			val h14_line = word("N","line",14);

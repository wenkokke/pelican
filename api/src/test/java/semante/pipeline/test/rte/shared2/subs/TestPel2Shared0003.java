...
public final class TestPel2Shared0003 extends AbsPipelineTest {
		...
		public final void testPel2Shared0003() throws Exception {
			...
			val t09_john = word("$NPC_1$","John",9);
			val t10_traynor = word("NP_D","Traynor",10);
			...
			val h02_traynor = word("NP_D","Traynor",2);

...
public final class TestPel2Shared0082 extends AbsPipelineTest {
		...
		public final void testPel2Shared0082() throws Exception {
			...
			val t07_supreme = word("$NPC_1$","Supreme",7);
			val t08_judicial = word("$NPC_1$","Judicial",8);
			val t09_court = word("NP_D","Court",9);

...
public final class TestPel2Shared0012 extends AbsPipelineTest {

		@Test
		public final void testPel2Shared0012() throws Exception {

			// create the vocabulary for the text;
			val t01_george = word("$NPC_1$","George",1);
			val t02_bush = word("NP_D","Bush",2);
			...
			val t27_emergency = word("$NC_1$","emergency",27);
			val t28_stockpile = word("N","stockpile",28);

			// create the vocabulary for the hypothesis;
			val h01_an = word("A","An",1);
			val h02_oilhappy = word("MI","oilHappy",2);
			val h03_presidential = word("$NC_1$","presidential",3);
			val h04_cabinet = word("N","cabinet",4);

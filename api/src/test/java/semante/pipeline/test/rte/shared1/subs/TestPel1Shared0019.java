...
public final class TestPel1Shared0019 extends AbsPipelineTest {

		@Test
		public final void testPel1Shared0019() throws Exception {

			// create the vocabulary for the text;
			val t01_javier = word("$NPC_1$","Javier",1);
			val t02_solana = word("NP_D","Solana",2);
			...
			val h01_javier = word("$NPC_1$","Javier",1);
			val h02_solana = word("NP_D","Solana",2);

...
public final class TestPel2Shared0009 extends AbsPipelineTest<Integer> {
		...
		public final void testPel2Shared0009() throws Exception {
			...
			val t45_ariel_sharon = word("NP_D","Ariel_Sharon",45);
			...
			val t41_gaza_strip = word("NP_D","Gaza_Strip",41);

			// create the vocabulary for the hypothesis;
			val h13_ariel_sharon = word("NP_D","Ariel_Sharon",13);

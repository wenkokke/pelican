...
public final class TestPel2Shared0112 extends AbsPipelineTest {
		...
		public final void testPel2Shared0112() throws Exception {
			...
			val t09_walter = word("$NPC_1$","Walter",9);
			val t10_cronkite = word("NP_D","Cronkite",10);
			...
			val h06_walter = word("$NPC_1$","Walter",6);
			val h07_cronkite = word("NP_D","Cronkite",7);

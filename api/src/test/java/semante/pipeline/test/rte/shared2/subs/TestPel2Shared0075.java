...
public final class TestPel2Shared0075 extends AbsPipelineTest {
		...
		public final void testPel2Shared0075() throws Exception {
			...
			val t20_world = word("$NPC_1$","World",20);
			val t21_trade = word("$NPC_1$","Trade",21);
			val t22_organization = word("NP_D","Organization",22);
			...
			val h04_member = word("$NC_1$","member",4);
			val h05_countries = word("N","countries",5);

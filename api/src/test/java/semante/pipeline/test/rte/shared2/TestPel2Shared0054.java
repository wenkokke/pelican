...
public final class TestPel2Shared0054 extends AbsPipelineTest<Integer> {
		...
		public final void testPel2Shared0054() throws Exception {
			...
			val t41_technology_licensing_company = word("N","technology_licensing_company",41);
					...
					_(
						...
						_(
							...
							_(
								t03_wireless
								,
								t41_technology_licensing_company
								,
								42
							)
							,

...
public final class TestPel1Shared0003 extends AbsPipelineTest {
		...
		public final void testPel1Shared0003() throws Exception {
			...
			val t05_sonia = word("$NPC_1$","Sonia",5);
			val t06_gandhi = word("NP_D","Gandhi",6);
			...
			val t24_ruling = word("$NC_1$","ruling",24);
			val t25_coalition = word("N","coalition",25);

			// create the vocabulary for the hypothesis;
			val h01_ms = word("$NPC_1$","Ms",1);
			val h02_gandhi = word("NP_D","Gandhi",2);

...
public final class TestPel1Shared0020 extends AbsPipelineTest {
		...
		public final void testPel1Shared0020() throws Exception {
			...
			val t17_kwazulunatal = word("$NPC_1$","KwaZuluNatal",17);
			val t18_province = word("NP_D","Province",18);
			val t51_app = word("WHO_A","APP",51);
			val t20_south = word("$NPC_1$","South",20);
			val t21_africa = word("NP_D","Africa",21);
			...
			val h06_kwazulunatal = word("$NPC_1$","KwazuluNatal",6);
			val h07_province = word("NP_D","Province",7);
		...
		subs.add(new IPair<Integer,Integer>(17,6));

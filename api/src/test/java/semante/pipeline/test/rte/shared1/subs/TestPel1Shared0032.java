...
public final class TestPel1Shared0032 extends AbsPipelineTest {
		...
		public final void testPel1Shared0032() throws Exception {
			...
			val t10_roman = word("$NC_1$","Roman",10);
			val t11_catholic = word("$NC_1$","Catholic",11);
			val t12_priest = word("N","priest",12);
			val t13_who = word("WHO_A","who",13);
			val t14_in = word("P_R","in",14);
			val t15_december = word("$NPC_1$","December",15);
			val t17_num1990 = word("NP_D","num1990",17);

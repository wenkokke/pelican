...
public final class TestPel2Shared0040 extends AbsPipelineTest {
		...
		public final void testPel2Shared0040() throws Exception {
			...
			val t05_mona = word("$NPC_1$","Mona",5);
			val t06_lisa = word("NP_D","Lisa",6);
			...
			val t15_leonardo = word("$NPC_1$","Leonardo",15);
			val t16_da = word("$NPC_1$","da",16);
			val t17_vinci = word("NP_D","Vinci",17);
			...
			val h02_mona = word("$NPC_1$","Mona",2);
			val h03_lisa = word("NP_D","Lisa",3);
			val h31_app = word("WHO_A","APP",31);
			val h05_painted = word("V_1","painted",5);
			val h06_by = word("P_R","by",6);
			val h07_da = word("$NPC_1$","da",7);
			val h08_vinci = word("NP_D","Vinci",8);

...
public final class TestPel1Shared0035 extends AbsPipelineTest {
		...
		public final void testPel1Shared0035() throws Exception {
			...
			val t06_central = word("$NPC_1$","Central",6);
			val t07_bank = word("NP_D","Bank",7);
			...
			val t12_hans = word("$NPC_1$","Hans",12);
			val t13_tietmeyer = word("NP_D","Tietmeyer",13);
			...
			val h01_hans = word("$NPC_1$","Hans",1);
			val h02_tietmeyer = word("NP_D","Tietmeyer",2);

...
public final class TestPel1Shared0032 extends AbsPipelineTest {
		...
		public final void testPel1Shared0032() throws Exception {
			...
			val sh000_won = word("V_2","won");
			val sh001_an = word("A","an");
			val sh002_overwhelming = word("MR","overwhelming");
			val sh003_victory = word("N","victory");
			val sh004_in = word("P_R","in");
			val sh005_haiti = word("NP_D","Haiti");
			val sh006_'s = word("GEN","'s");
			val sh007_only = word("MR","only");
			val sh008_democratic = word("MR","democratic");
			val sh009_presidential = word("MR","presidential");
			val sh010_election = word("N","election");
val st0 = 
			_(
				st000_won
				,

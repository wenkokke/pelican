...
public class TestCaseIntPp01 extends ATestCase {
	...
	public final TestData createTest() throws Exception {
		String text = "EXISTS:(et)t (\\x0:e.((AND:ttt ((AND:ttt (man:et x0:e)) ((from:eet Brasil:e) x0:e))) ((EQ:eet x0:e) jan:e)))";
		...
		ExpectedPredCalc epc = new ITestData.IExpectedPredCalc(
									"",
									"exists x0 ((man(x0) & from(Brasil, x0)) & x0=jan).",
